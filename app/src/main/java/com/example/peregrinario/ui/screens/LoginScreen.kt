    ...
    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        AnimatedVisibility(
            ...
            Column(
                ...
                Text("Peregrinário!", fontSize = 30.sp, style = MaterialTheme.typography.headlineLarge)
                ...
                Button(
                    ...
                    /*
                    Icon(
                        painter = painterResource(id = com.google.android.gms.auth.api.R.drawable.common_google_signin_btn_icon_dark_normal),
